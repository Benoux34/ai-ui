...
import { Database, Globe, Loader2, Send } from "lucide-react";
...
type Props = {
  ...
  disabled?: boolean;
  isWeb: boolean;
  setIsWeb: Dispatch<SetStateAction<boolean>>;
  isRag: boolean;
  setIsRag: Dispatch<SetStateAction<boolean>>;
};
  ...
  return (
    <div className="w-full">
      <div className="flex items-end gap-x-3 mb-3">
        <Button
          className={cn(
            "h-[40px] w-[40px] bg-[#121212] border border-gray-600",
            "transition-all duration-200 cursor-pointer",
            isWeb ? "opacity-100" : "opacity-50"
          )}
